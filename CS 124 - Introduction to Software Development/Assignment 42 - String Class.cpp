/*******************************************************************************
* Program:
*    Assignment 42, Dem Bones (String Class)
*    Brother Honeycutt, CS124
* Author:
*    Chris Van Ry
* Summary:
*    This program will display the words to the song Dem Bones by using the
*    string class.
* 
*    Estimated: 0.75 hr
*    Actual:    1.0 hr
...
*    instructions. I wrote out the whole song inserting the array index and then
*    realized I could just traverse the array and insert each element that way.
*******************************************************************************/
