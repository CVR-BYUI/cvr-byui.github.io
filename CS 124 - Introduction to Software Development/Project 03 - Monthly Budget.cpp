...
*    Actual: 5.0 hr
* 
*    The most difficult part of writing this program was figuring out how
*    main() is structured to put all of the functions together as well as 
...
{
    // return value to main()
    double budgetTax = monthlyIncome * 0;
    return budgetTax;
}
...
double budgetOther(double monthlyIncome, double budgetLiving)
{
    ...
    double budgetOther = monthlyIncome - (computeTithing(monthlyIncome) + 
    budgetLiving);
    return budgetOther; 
}
