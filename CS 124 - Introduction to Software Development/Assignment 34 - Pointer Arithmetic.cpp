...
*    how many occurrences the letter appears in the text.
* 
*    Estimated: 0.75 hr
*    Actual: 2.0 hr
* 
*    The most difficult part of writing this program was implementing the
*    pointer properly. I ran into errors due to missing the asterisk before p
*    in my if statement.
*******************************************************************************/
...
/*******************************************************************************
* COUNT LETTERS
* This will traverse the string using a pointer and count how many occurrences 
* the user input letter appears.
*******************************************************************************/
