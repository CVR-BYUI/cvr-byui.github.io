...
*    Actual:     2.0 hrs
*
*    The most difficult part of writing (editing) this program was
*    underestanding how it was searching. If not for the comments, I would
*    be lost. I used the example from the book for help on completing this.
************************************************************************/
